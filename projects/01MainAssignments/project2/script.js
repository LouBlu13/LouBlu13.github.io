...
function draw() {
  ...
  // original smooth scroll + fall-back
  ...
  for (let i = 0; i < products.length; i++) {
    ...
    // Begrenzungen des Buttons innerhalb der Karte
    ...
    // stabile Kollisionen (Verhindern Hängenbleiben / Rausfliegen)
    if (p.btnX < left) {
      p.btnX = left;
      p.btnVX *= -1;
    }
...
function mouseReleased() {
  ...
  //Seite soll wieder nach oben zurückfallen
  targetScroll = 0;
}
